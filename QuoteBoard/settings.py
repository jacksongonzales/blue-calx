...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/jacksongonzales/projects/QuoteBoard/sqlite3.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'i#asu(xly!-75&amp;h%bp(zxna1zbjfb0i)jtg(8g4=c%8_a9&amp;879'
